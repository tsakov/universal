(function () {
    ...
    gpii.requests.request.handler.preferencesChangedPreInit = function (that) {
        ...
        that.mergePreferences = function (oldPreferences, newPreferences) {
            return fluid.jQueryStandalone.extend(oldPreferences, newPreferences);
        };
    ...
    gpii.requests.request.handler.cacheUserInformation = function (token, preferences, device) {
        console.log("\n//////////////////////////////\n", token, "\n//////////////////////////////\n");
        console.log("\n//////////////////////////////\n", preferences, "\n//////////////////////////////\n");
        console.log("\n//////////////////////////////\n", device, "\n//////////////////////////////\n");
    };
