(function ($, fluid) {       
    ...
    gpii.pcp.genericCheckbox.genericCheckboxPreInit = function (that) {
        ...
        selectors[id] = ".flc-uiOptions-genericCheckbox";
        selectors[id + "Label"] = ".flc-uiOptions-genericCheckboxLabel";
        selectors[id + "Description"] = ".flc-uiOptions-genericCheckboxDescription";
