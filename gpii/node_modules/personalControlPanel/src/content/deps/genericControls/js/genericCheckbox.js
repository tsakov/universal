(function ($, fluid) {       
    ...
    gpii.pcp.genericCheckbox.genericCheckboxPreInit = function (that) {
        var selectors = {};
        selectors[that.options.id] = ".flc-uiOptions-genericCheckbox";
        selectors[that.options.id + "Label"] = ".flc-uiOptions-genericCheckboxLabel";
        selectors[that.options.id + "Description"] = ".flc-uiOptions-genericCheckboxDescription";

        that.options.selectors = selectors;
        that.options.defaultModel[that.options.id] = false;
    };
