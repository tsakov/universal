(function ($, fluid) {       
    ...
    gpii.pcp.genericDropdown.genericDropdownPreInit = function (that) {
        ...
        selectors[id] = ".flc-uiOptions-genericDropdown";
        selectors[id + "Label"] = ".flc-uiOptions-genericDropdownLabel";
        selectors[id + "Description"] = ".flc-uiOptions-genericDropdownDescription";
