...
var transformPayload = function (preferences) {
    ...
    for (var i = 0; i < preferences.length; ++i) {
        ...
        currentPreference.resources = {};
        currentPreference.resources.template = "{templateLoader}.resources." + preferenceName;

        result.distributeOptions[0].record[preferenceName] = "temp/" + preferenceName + ".html";
